...
3. open the project folder and activate your Virtual Environment by running the following Command in cmd
    
    activate myenv
     
4. Create a SQLite database and update the `SQLALCHEMY_DATABASE_URI` in `app.py` with your database URI by using folowing command in cmd window.
